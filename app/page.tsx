...
async function getRankingData(): Promise<{ entries: RankingEntry[]; total: number }> {
...
export default async function HomePage() {
  const { entries: data, total } = await getRankingData();
  ...
  return (
    <>
      ...
      <RankingClient initialData={data} initialTotal={total} />
